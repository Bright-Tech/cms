...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      query: { inculde: ['point_content_name', 'parent_navigation_name', 'point_category_name'] },
      defaultQuery: { inculde: ['point_content_name', 'parent_navigation_name', 'point_category_name'] },
      categoryList: [],
      contentBlogList: []
    };
  },
