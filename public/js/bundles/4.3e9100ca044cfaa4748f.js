...
Component.options.__file = "resources/assets/js/views/admin/navigation_manager/navigation.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-62ac621e", Component.options)
  } else {
    hotAPI.reload("data-v-62ac621e", Component.options)
' + '  }
...
Component.options.__file = "resources/assets/js/views/admin/navigation_manager/_dialog.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2219d74d", Component.options)
  } else {
    hotAPI.reload("data-v-2219d74d", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            ruleValidate: {
                ...
                point_categroy_id: [{ required: true, type: 'integer', message: '分类必填', trigger: 'change' }],
    ...
    methods: {
        ...
        getCategroyList: function getCategroyList() {
            var self = this;
            axios.get('/api/admin/category').then(function (res) {
                self.categroyList = res.data.data;
                //                    console.log(self.categroyList);
            });
        },
        getContentBlogList: function getContentBlogList() {
            var self = this;
            axios.get('/api/admin/content-blog/' + this.model.point_category_id + '?include=category').then(function (res) {
                self.contentBlogList = res.data;
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                _vm._l(_vm.categroyList, function(item) {
                                  return _c(
                                    "i-option",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2219d74d", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/views/admin/navigation_manager/_table.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-42d9aa59", Component.options)
  } else {
    hotAPI.reload("data-v-42d9aa59", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
                ...
                _c("td", [
                  props.item.point_category_id == null
                    ...
                    : _c(
                        "span",
                        [
                          _vm._l(_vm.categroyList, function(item, index) {
                            return [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-42d9aa59", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-62ac621e", module.exports)
  }
}
