...
exports.default = {
    ...
    data: function data() {
        ...
        var validateReset = function validateReset(rule, value, callback) {
            if (value.length >= 6 && value.length < 25) {
                callback();
            } else {
                callback(new Error('密码长度应为6-25个字符！'));
        ...
        return {
            ...
            ruleValidate: {
                ...
                reset: [{ required: true, validator: validateReset, trigger: 'blur' }],
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      ruleValidate: {
        password: [
          //                  {minLength: minLength(6),message: '密码长度为6~25个字符' , trigger: 'blur'}
