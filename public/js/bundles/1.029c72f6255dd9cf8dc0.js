  ...
  data: function data() {
    ...
    return {
      ...
      ruleValidate: {
        ...
        point_category_id: [{ required: true, validator: validatePointCategoryId, trigger: 'blur' }],
        point_content_id: [{ required: true, validator: validatePointContentId, trigger: 'blur' }]
      }
    };
  },
  created: function created() {
